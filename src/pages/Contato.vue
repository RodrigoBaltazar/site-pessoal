...
const socialLinks = ref([
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/rodrigo-baltazar-dev/',
  ...
  {
    name: 'GitHub',
    url: 'https://github.com/RodrigoBaltazar',
  ...
  {
    name: 'Instagram',
    url: 'https://www.instagram.com/rodrigobaltazar00/',
...
const handleSubmit = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Ocorreu um erro ao enviar a mensagem. Tente novamente.'
    console.error(err)
  } finally {
    loading.value = false
  }
...
<template>
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mb-12">
      <h2 class="text-3xl font-bold text-gray-900 mb-6 text-center">Conecte-se Comigo</h2>
      <div class="flex justify-center space-x-6">
        <a
          ...
          :class="[
            link.bgColor,
            'p-4 rounded-lg transform transition-transform hover:scale-110'
          ]"
        >
          <svg
    ...
    <div class="relative my-12">
      ...
      <div class="relative flex justify-center text-sm">
        <span class="px-4 bg-gray-100 text-gray-500">Ou envie uma mensagem</span>
      </div>
    </div>

    <!-- Formulário de Contato -->
    <div class="max-w-2xl mx-auto">
      <h2 class="text-3xl font-bold text-gray-900 mb-8 text-center">Entre em Contato</h2>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <button
          type="submit"
          class="w-full bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition-colors duration-200 disabled:opacity-50"
          :disabled="loading"
        >
